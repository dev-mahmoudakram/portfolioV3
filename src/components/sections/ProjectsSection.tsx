      ...
      <div className="grid gap-8 lg:grid-cols-[1.25fr_0.75fr]">
        ...
        <div className="hidden lg:flex flex-col items-center justify-center gap-6">
          <div className="relative flex min-h-[420px] w-full items-center justify-center overflow-hidden">
            ...
            <Image
              src="/images/char/rails-projects.png"
              alt="Abdelrahman Yasser presenting projects"
              width={1280}
              height={1280}
              sizes="360px"
              className="relative z-10 h-auto w-full max-w-[390px] drop-shadow-[0_16px_36px_rgba(0,0,0,0.4)]"
            />
          </div>
        </div>
      </div>
