...
const projects = [
  {
    ...
    techStack: ["Next.js", "TypeScript", "Tailwind", "Ruby on Rails", "PostgreSQL"],
    category: "dashboard",
  ...
  },
  {
    ...
    image: "/images/project-placeholder.svg",
    techStack: ["Ruby on Rails", "Next.js", "PostgreSQL", "Sidekiq", "Docker"],
    category: "full-stack",
...
const skills = [
  ...
  ["Ruby", "backend", "fa-solid fa-gem", 3],
  ["Ruby on Rails", "backend", "fa-solid fa-server", 4],
  ["Sidekiq", "backend", "fa-solid fa-bolt", 5],
  ["ActiveJob", "backend", "fa-solid fa-clock", 6],
  ["MVC Architecture", "backend", "fa-solid fa-sitemap", 7],
  ["Docker", "backend", "fa-brands fa-docker", 8],
  ["AWS", "backend", "fa-brands fa-aws", 9],
  ["ActiveRecord ORM", "database", "fa-solid fa-database", 1],
  ["MySQL", "database", "fa-solid fa-database", 2],
  ["PostgreSQL", "database", "fa-solid fa-database", 3],
  ["SASS", "cms", "fa-brands fa-sass", 1],
  ["LESS", "cms", "fa-solid fa-file-code", 2],
